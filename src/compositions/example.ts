...
export const composition = new Composition({width: 1280, height:720});
export const video = await VideoSource.from('/drone_footage_1080p_25fps.mp4');
export const clip = await composition.add(new VideoClip(video));
